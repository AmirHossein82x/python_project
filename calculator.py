...
def equal():
    ...
    try:
        ...
        equation_label.set('you can not divide by 0')
        equation_text = ""

    except SyntaxError:

        equation_label.set('please enter correctly')
        equation_text = ""
...
deximal = Button(frame, text='.', height=4, width=9, font=35, command=lambda:button_press('.'))
deximal.grid(row=3, column=1)
